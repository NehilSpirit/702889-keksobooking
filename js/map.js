...
// @oldfox переименуйте в getRandomElement или что-то похожее
var getRandomElement = function(arr) {
  return arr[Math.floor(Math.random() * arr.length)];
};

// @oldfox перемешивание Фишер-Йетс
...
var createInfo = function(num) {    
    ...
    return  {
      ...
      offer: {
        ...
        kind: getRandomElement(offerKind),
...
console.log(item);
  ...
  // @oldfox генерируем и добавляем элементы
